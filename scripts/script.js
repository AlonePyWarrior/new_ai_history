...
const answers_of_short_quizes = {
    "0":{
        "0" : `تا حدودی<span>&#129300;</span>
        اگر تفکر را به عنوان توانایی پردازش اطلاعات و حل مسائل تعریف کنیم، در این صورت می‌توان گفت که ماشین‌ها می‌توانند فکر کنند.
        اما اگر بخواهیم  تعریف دقیقی از "تفکر" داشته باشیم. میتوانیم تفکر را به عنوان پدیده‌ پیچیده ای در نظر بگیریم که به عوامل مختلفی بستگی دارد. \n\  
        مانند: \n\
        ...
        با توجه به این تعریف پاسخ به این سوال دشوار میشود و میتوانیم بگوییم که ماشین ها هنوز از تمام توانمندی های ذکر شده در رابطه با تفکر انسان برخوردار نیستند. 
        با پیشرفت‌های اخیر در هوش مصنوعی، احتمال اینکه در آینده ماشین‌هایی بسازیم که بتوانند در برخی از زمینه‌ها به همان شکلی که انسان فکر می‌کند، فکر کنند، وجود دارد. اما هنوز مشخص نیست که آیا ماشین‌ها می‌توانند به طور کامل به سطح هوش انسان برسند یا خیر(بعد تر در همین فاز به وصرت دقیق تر به این موضوع خواهیم پرداخت).    
        
        `,
        "1": `نمیتوان با قطعیت گفت<span>&#129300;</span>.
        اگر فکر را به عنوان توانایی پردازش اطلاعات و حل مسائل تعریف کنیم، در این صورت می‌توان گفت که ماشین‌ها می‌توانند فکر کنند.
        اما اگر بخواهیم  تعریف دقیقی از "فکر" داشته باشیم. میتوانیم تفکر را به عنوان پدیده‌ پیچیده ای در نظر بگیریم  که به عوامل مختلفی بستگی دارد. برخی از عوامل عبارتند از:
        ...
        توانایی خلاقیت
        توانایی تفکر انتزاعی
        با این تعریف پاسخ به این سوال دشوار میشود و میتوانیم بگوییم که ماشین ها هنوز از تمام توانمندی های ذکر شده در رابطه با تفکر انسان برخوردار نیستند 
